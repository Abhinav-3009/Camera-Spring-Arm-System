...
function addGround() {
    /**
 * adding plane ground to the scene using plane geometry then making it horizontal
 */
...
function adjustCameraToAvoidObstacles() {
    ...
    if (intersections.length > 0) {
        ...
        // todo 
        newCameraPosition.multiplyScalar(distanceToObstacle + 0.5); // Adjust the 0.5 as needed check this later
    ...
    // console.log('original pos: '+ originalPosition);
